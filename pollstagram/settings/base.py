...
MEDIA_URL = S3_URL.format(bucket_name=AWS_STORAGE_BUCKET_NAME, root=MEDIA_ROOT)
...
STATIC_URL = S3_URL.format(bucket_name=AWS_STORAGE_BUCKET_NAME, root=STATIC_ROOT)
