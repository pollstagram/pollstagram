...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'poll_userprofile', 'location')

        # Adding field 'UserProfile.country'
        db.add_column(u'poll_userprofile', 'country',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'poll_userprofile', 'location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'UserProfile.country'
        db.delete_column(u'poll_userprofile', 'country')
