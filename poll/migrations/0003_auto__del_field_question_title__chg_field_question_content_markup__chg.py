...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('poll_question', 'title')


        # Changing field 'Question.content_markup'
        db.alter_column('poll_question', 'content_markup', self.gf('django.db.models.fields.TextField')(max_length=255))

        # Changing field 'Question.content_markdown'
        db.alter_column('poll_question', 'content_markdown', self.gf('django.db.models.fields.TextField')(max_length=255))

    def backwards(self, orm):
        # Adding field 'Question.title'
        db.add_column('poll_question', 'title',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=255),
                      keep_default=False)


        # Changing field 'Question.content_markup'
        db.alter_column('poll_question', 'content_markup', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Question.content_markdown'
        db.alter_column('poll_question', 'content_markdown', self.gf('django.db.models.fields.TextField')())
