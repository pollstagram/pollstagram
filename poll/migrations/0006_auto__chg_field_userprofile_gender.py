...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'poll_userprofile', 'gender', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'UserProfile.gender'
        db.alter_column(u'poll_userprofile', 'gender', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'poll.userprofile': {
            ...
            'bio': ('django.db.models.fields.TextField', [], {'max_length': '255'}),
